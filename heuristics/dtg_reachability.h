 ...
 */
class DTGReachability : public MyPOP::HEURISTICS::HeuristicInterface
{
public:
	/**
	 * Constructor.
...
private:
	...
	std::pair<const ReachableFactLayerItem*, std::vector<const Object*>**> createNewGoal(const GroundedAtom& resolved_goal);
