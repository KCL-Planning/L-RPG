...
const SASActionTemplate* FunctionStructure::getSASActionTemplate(const operator_& op) const
{
	SASActionTemplates::const_iterator ci = sasActionTemplates.find(&op);

	if (ci == sasActionTemplates.end())
	{
		return NULL;
	}
